...
$keepcmspages=array('voucher-codes','trade-program','affiliate-program','new-product-request','price-match-promise','lifetime-guarantee');
$keepcsmblocks=array('contact-us');
